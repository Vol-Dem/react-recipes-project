      ...
      <Card className={classes.policy}>
        ...
        <ul className={classes["policy__list"]}>
          <li className={classes["policy__list-item"]}>
            ...
            as your name, email address, payment details, and account
            credentials.
          </li>
          <li className={classes["policy__list-item"]}>
            <strong>Usage Data:</strong> Information about how you use our
            Services, including IP addresses, browser types, and interactions
            with the website.
          </li>
          <li className={classes["policy__list-item"]}>
        ...
        <ul className={classes["policy__list"]}>
          <li className={classes["policy__list-item"]}>
            ...
            in delivering our Services (e.g., payment processors, hosting
            providers).
          </li>
          <li className={classes["policy__list-item"]}>
            <strong>Legal Authorities:</strong> When required by law or
            necessary to protect our rights and users.
          </li>
        </ul>
        <h2 className={classes["policy__h4"]}>
